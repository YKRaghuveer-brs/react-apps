    ...
    <main className="pt-5 pb-5">
      <section className="container content-section">
        ...
        <div className="shop-items">
          <ShopItem title="Nokia" price="₹10000" image="/items/m1.jpg" addToCart={addToCart} />
          <ShopItem title="Samsung" price="₹12000" image="/items/m2.jpg" addToCart={addToCart} />
          <ShopItem title="Apple" price="₹45000" image="/items/m3.jpg" addToCart={addToCart} />
          <ShopItem title="Sony" price="₹20000" image="/items/m4.jpg" addToCart={addToCart} />
        </div>
      </section>
      <section className="container content-section">
        <h2 className="section-header">Laptop</h2>
        <div className="shop-items">
          <ShopItem title="HP" price="₹50000" image="/items/dell.jpg" addToCart={addToCart} />
          <ShopItem title="Dell" price="₹75000" image="/items/l2.jpg" addToCart={addToCart} />
          <ShopItem title="Samsung" price="₹60000" image="/items/l3.jpg" addToCart={addToCart} />
          <ShopItem title="Lenova" price="₹65000" image="/items/l4.jpg" addToCart={addToCart} />
        </div>
      </section>
      <section className="container content-section">
        ...
        {showConfirmation && (
          <div className="confirmation-popup">
            ...
            <button className="btn btn-primary" onClick={handleCloseConfirmation}>
              OK
            </button>
          </div>
        )}
